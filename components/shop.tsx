...
import { BaybayinText } from './BaybayinText'
      ...
      <header className="bg-neutral-950 text-white sticky top-0 z-50">
        ...
        <div className="max-w-7xl mx-auto px-4 py-3 md:py-4 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 shrink-0 cursor-pointer">
            ...
            {/* <span
              style={{ fontFamily: "'Bagwis', serif" }}
              className="hidden font-bagwis md:block text-2xl font-bold tracking-tight"
            >
              ᜆᜒᜈ᜔ᜇᜑᜈ᜔
            </span> */}
            <BaybayinText>ᜆᜒᜈ᜔ᜇᜑᜈ᜔</BaybayinText>
          </div>
